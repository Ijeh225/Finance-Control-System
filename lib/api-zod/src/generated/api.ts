...
export const GetScheduledTodayResponse = zod.object({
  ...
  "status": zod.enum(['pending', 'approved', 'rejected', 'on_hold', 'partial', 'paid', 'overdue', 'withdrawn']),
  "withdrawnAt": zod.string().nullish(),
  "withdrawnBy": zod.string().nullish(),
  "withdrawnByName": zod.string().nullish(),
 ...
 */
export const GetVendorSpendingParams = zod.object({
  "id": zod.coerce.string()
})

export const GetVendorSpendingResponse = zod.object({
  "vendorId": zod.string(),
  "vendorName": zod.string(),
  "totalPaid": zod.number(),
